    ...
    <a-col :md="leftColMd" :sm="24" style="margin-bottom: 20px">
      <a-card :bordered="false">
        ...
        <div style="margin-top: 15px">
          ...
          <a @click="handleOpen(record)">用户授权</a>
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item>
                <a-popconfirm title="确定删除当前角色吗?" @confirm="() => handleDelete1(record.id)">
                  <a v-if="record.roleCode!='devAdmin'">删除角色</a>
                </a-popconfirm>
              </a-menu-item>
            </a-menu>
          </a-dropdown>
      ...
      <a-card :bordered="false">
        ...
        <div class="table-page-search-wrapper">
          <a-form layout="inline">
            <a-row :gutter="24">
              <a-col :md="2" :sm="2">
                <a-icon type="menu-unfold" style="fontSize: 20px;" @click="sideCollapse"/>
              </a-col>
              <a-col :md="12" :sm="12">
            ...
            <a-col :md="6" :sm="24">
             <a-button type="primary" @click="searchQuery2" icon="search" style="margin-left: 21px">查询</a-button>
              <a-button type="primary" @click="searchReset2" icon="reload" class="m-l-6">重置</a-button>
       ...
       <!--   <a-button @click="handleAdd2" type="primary" icon="plus" style="margin-top: 16px">用户录入</a-button>-->
          ...
          <a-button @click="handleAddUserRole" type="primary" icon="plus" style="margin-top: 16px">为角色授权用户</a-button>
