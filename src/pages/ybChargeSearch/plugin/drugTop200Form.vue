          ...
          <a-row :gutter="24">
            ...
            <a-col :md="8" :sm="8">
              <a-form-item label="项目名称" >
                <a-input placeholder="请输入项目名称,多个项目用#分隔" v-decorator="['itemname', {}]" ></a-input>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="6">
...
export default {
  ...
  methods: {
    ...
    setFormData(data,selectOrgsArr){
      this.form.setFieldsValue(pick(data,'chargedateStartdate','chargedateEnddate'))
      this.$nextTick(() => {
        this.searchQuery()
      })
    },
