      ...
      <div class="table-page-search-wrapper">
        <a-form :form="form"  layout="inline">
          <a-row :gutter="24">
            ...
            <a-col :md="8" :sm="8">
              <a-form-item label="医保项目名称" >
                <a-input placeholder="请输入医保项目名称,多个项目用#分隔" v-decorator="['itemname', {}]" ></a-input>
              </a-form-item>
            </a-col>
          </a-row>
        </a-form>
      ...
      <searchQueryList ref="searchQueryList"
        ...
        <div style="margin:0 30px;" slot="createTaskBtn">
          <div  v-has="'ybChargeTask:createTask'">
            ...
            <a-button type="primary"  @click="searchQuery" style="float:right;">查询</a-button>
          </div>
...
export default {
  name: "drugTop200DetailForm",
  mixins:[orgSelectMixin,taskQueryFormMixin],
  props: {
    taskType: {
      type: String,
      default:'drug_top200_detail'
    },
  },
  components: {
    MDictSelectTag,
  ...
  methods: {
    ...
    setFormData(data,selectOrgsArr){
      this.form.setFieldsValue(pick(data,'orgs','chargedateStartdate','chargedateEnddate'))
      this.orgs = data.orgs
