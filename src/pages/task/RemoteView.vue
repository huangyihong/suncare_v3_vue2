<template>
  <a-spin :spinning="loading" size="large" tip="正在加载...">
    <iframe :id="id" :src="url" frameborder="0" width="100%" :height="height" scrolling="auto" ref="iframeRef"
    ></iframe>
  </a-spin>
</template>
  ...
  /*  updated () {
    ...
    methods: {
      goUrl () {
        ...
        url = host + url + "?token=" +  this.$ls.get(ACCESS_TOKEN)
