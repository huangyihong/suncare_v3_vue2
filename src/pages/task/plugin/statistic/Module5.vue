<template>
  <div>
    ...
    <a-button type="primary" @click="handleExportFile('初审/复审结果对比.xlsx')" class="fr">导出</a-button>
  ...
  export default {
    ...
    data() {
      this.url = {
        ...
        list: this.$suncare_v3 + '/apiReviewStatistic/module5',
        exportXlsUrl: this.$suncare_v3 + '/apiReviewStatistic/module5Export',
      }
      return {
        tabs: [],
        activeKey: 'all',
        ...
        columns: [{
        ...
        },
          {
            ...
            align: "center",
            width: 100,
            customRender: (t, r, i) => this.compareColorRender(r,'visitidCount'),
          },
          {
            title: '记录数变化',
            align: "center",
            width: 100,
            customRender: (t, r, i) => this.compareColorRender(r, 'count'),
          },
          {
            title: '收费项目数变化',
            align: "center",
            width: 100,
            customRender: (t, r, i) => this.compareColorRender(r, 'itemcodeCount'),
          },
          {
            title: '违规金额变化',
            align: "center",
            width: 100,
            customRender: (t, r, i) => this.compareColorRender(r, 'sumMinMoney', true),
          },
          {
            title: '违规基金金额变化',
            align: "center",
            width: 100,
            customRender: (t, r, i) => this.compareColorRender(r, 'sumActionMoney', true),
          },],
        initLoad: false,
    ...
    methods: {
      ...
      compareColorRender(r, field, toFixed){
        let val1 = r.facet1.count === 0? 0: r.facet1[field]
        let val2 = r.facet2.count === 0? 0: r.facet2[field]
        let num = val2 - val1
        if(toFixed){
          num = num.toFixed(2)
        }
