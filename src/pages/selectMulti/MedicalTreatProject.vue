<template>
    <a-row :gutter="24">
        <a-col :span="4" style="overflow: auto" :style="{maxHeight:scrollH}">
            <other-dict-tree @selectNode="searchData" dictEname="STD_TreatmentClassify"
                             :showCode="true"></other-dict-tree>
        </a-col>
                    ...
                    <a-row :gutter="24">
                        <a-col :xl="6" :lg="8" :sm="12">
                            <a-form-item label="医疗服务项目编码">
                                <j-input placeholder="请输入医疗服务项目编码模糊查询(,代表与|代表或)" type="more"
                                         v-model="queryParam.code"></j-input>
                            </a-form-item>
                        </a-col>
                        <a-col :xl="6" :lg="8" :sm="12">
                            <a-form-item label="医疗服务项目名称">
                                <j-input placeholder="请输入医疗服务项目名称模糊查询(,代表与|代表或)" type="more"
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/config/medicalTreatProject/list",
          selectAll: "/config/medicalTreatProject/selectAll",
        },
        fixedParam: {
          state: '1'
        },
