<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="目录原始项目名称">
              <j-input placeholder="请输入目录原始项目名称模糊查询" v-model="queryParam.itemnameSrc"></j-input>
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            ...
            <a-col :md="6" :sm="8">
              <a-form-item label="目录原始项目编码">
                <j-input placeholder="请输入目录原始项目编码模糊查询" v-model="queryParam.itemcodeSrc"></j-input>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
              <a-form-item label="项目地名称">
                <j-input placeholder="请输入项目地名称模糊查询" v-model="queryParam.projectArea"></j-input>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
    ...
    <!-- 表单区域 -->
    <StdWjItemcatalogModal ref="modalForm" @ok="modalFormOk"></StdWjItemcatalogModal>
...
<script>
import StdWjItemcatalogModal from './modules/StdWjItemcatalogModal'
...
export default {
  name: "StdWjItemcatalogList",
  mixins: [JeecgListMixin],
  components: {
    StdWjItemcatalogModal,
    ImportModal,
    moment
  },
  data() {
    return {
      ...
      /*  {
          title: '财务分类编码(原始)',
          dataIndex: 'chargeclassIdSrc',
          width:150,
          align:"left",
        },
        {
          title: '财务分类名称(原始)',
          dataIndex: 'chargeclassSrc',
          width:200,
          align:"center",
          ellipsis: true,
        },*/
       ...
       */
        {
          title: '市一级价格(元)',
          dataIndex: 'itemprice1',
          width:150,
          align:"left",
        },
        {
          title: '市二级价格(元)',
          dataIndex: 'itemprice2',
          width:150,
          align:"left",
        },
        {
          title: '市三级价格(元)',
          dataIndex: 'itemprice3',
          width:150,
          align:"left",
        },
        {
          title: '省级价格(元)',
          dataIndex: 'itempriceProvince',
          width:150,
          align:"left",
        },
        /*
        {
          title: '县一级价格(元)',
          dataIndex: 'itempricecounty1',
          width:150,
          align:"left",
        },
        {
          title: '县二级价格(元)',
          dataIndex: 'itempricecounty2',
          width:150,
          align:"left",
        },
        {
          title: '县三级价格(元)',
          dataIndex: 'itempricecounty3',
          width:150,
          align:"left",
        },
        {
      ...
      url: {
        list: "/config/stdWjItemcatalog/list",
        delete: "/config/stdWjItemcatalog/delete",
        deleteBatch: "/config/stdWjItemcatalog/deleteBatch",
        exportXlsUrl: "config/stdWjItemcatalog/exportXls",
        importExcelUrl: "config/stdWjItemcatalog/importExcel",
        exportExcel: "/config/stdWjItemcatalog/exportExcel",
      },
      queryParam2: {},
      tableName:'STD_WJ_ITEMCATALOG',
    }
  },
  computed: {
  ...
  methods: {
    ...
    handleExportExcel() {
      ...
      this.handleExportFile('医疗服务项目物价目录' + moment().format('YYYYMMDDHHmmss')+'.xlsx')
    },
    //导入
    handleImportExcel() {
      let param = {
        ...
        actionType: 'add',
        uploadFileName: 'STD_WJ_ITEMCATALOG.xlsx'
      }
