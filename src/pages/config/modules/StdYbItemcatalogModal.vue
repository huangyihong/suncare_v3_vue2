      ...
      <a-form :form="form">
        ...
        <a-col :md="12" :sm="24">
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="项目编码(原始)">
            <a-input placeholder="请输入项目编码(原始)" v-decorator="['itemcodeSrc', {}]" :readOnly="readonly"/>
          </a-form-item>
        </a-col>
        <a-col :md="12" :sm="24">
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="项目名称(原始)">
            <a-input placeholder="请输入项目名称(原始)" v-decorator="['itemnameSrc', validatorRules.required]" :readOnly="readonly"/>
          </a-form-item>
        </a-col>
        <a-col :md="24" :sm="24">
          <a-form-item
        ...
        <a-col :md="12" :sm="24">
          <a-form-item
            ...
            <a-input-number :step="1" :min="1" :max="100"
                            ...
                            v-decorator="['fundpayProp', {}]"></a-input-number>
          </a-form-item>
        </a-col>
        ...
        <a-col :md="12" :sm="24">
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="收费项目等级(映射后)">
            <other-dict-select-tag  placeholder="请选择收费项目等级" v-model="chargeattricodeSelect"  dictEname="ChargeAttri" :labelInValue="true" :readOnly="readonly"/>
          </a-form-item>
        </a-col>
        <a-col :md="24" :sm="24">
          <a-form-item
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/config/stdYbItemcatalog/add",
          edit: "/config/stdYbItemcatalog/edit",
        },
        readonly:false,//只读
      ...
      edit (record) {
        ...
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'itemcode','itemname','chargeclassIdSrc','chargeclassSrc','itemcodeSrc','itemnameSrc',
            'itemContent','exceptContent','chargeunit','itempriceProvince','itemprice1','itemprice2','itemprice3','itempricecounty1','itempricecounty2','itempricecounty3','fundpayProp',
            'chargeattriSrc','itemnote','parentcode','parentname','fileName','createStaffName','updateStaffName','updateReason'))
          //时间格式化
