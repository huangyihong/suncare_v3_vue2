<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="8">
            <a-form-item label="序号">
              <a-input placeholder="输入序号查询" v-model="queryParam.orderNum"/>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" v-has="'basicDataManage:export'" icon="download" @click="handleExportExcel('药品属性表')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <medical-drug-property-modal ref="modalForm" @ok="myModalFormOk"></medical-drug-property-modal>
...
<script>
  ...
  import MedicalDrugPropertyModal from './modules/MedicalDrugPropertyModal'
  import OtherDictSelectTag from "./modules/OtherDictSelectTag"

  export default {
    name: "MedicalDrugPropertyList",
    mixins:[JeecgListMixin,MedicalAuditLogListMixin],
    components: {
      MedicalDrugPropertyModal,
      JDictSelectTag,
      OtherDictSelectTag,
    },
    data () {
      return {
        description: '药品属性表管理页面',
        // 表头
        columns: [
          {
            title: '序号',
          ...
          },
          {
            ...
            width:100,
            align:"center",
            dataIndex: 'presdrugSignname'
          },
          {
            title: '非处方药分类',
            width:100,
            align:"center",
            dataIndex: 'nonrxtypename'
          },
          {
            title: '毒性药品标志',
            width:100,
            align:"center",
            dataIndex: 'poisonousSignname'
          },
          {
            title: '麻醉药品标志',
            width:100,
            align:"center",
            dataIndex: 'narcoticSignname'
          },
          {
            title: '一类精神药品标志',
            width:100,
            align:"center",
            dataIndex: 'psych1Signname'
          },
          {
            title: '二类精神药品标志',
            width:100,
            align:"center",
            dataIndex: 'psych2Signname'
          },
          {
            title: '三类精神药品标志',
            width:100,
            align:"center",
            dataIndex: 'psych3Signname'
          },
          {
            title: '生物制品标志',
            width:100,
            align:"center",
            dataIndex: 'biologicSignname'
          },
          {
            title: '血液制品类标志',
            width:100,
            align:"center",
            dataIndex: 'bloodprodSignname'
          },
          {
            title: '放射性药品标志',
            width:100,
            align:"center",
            dataIndex: 'radioSignname'
          },
        ...
        url: {
          list: "/config/medicalDrugProperty/manageList",
          delete: "/config/medicalDrugProperty/delete",
          deleteBatch: "/config/medicalDrugProperty/deleteBatch",
          exportXlsUrl: "/config/medicalDrugProperty/exportXls",
          importExcelUrl: "/config/medicalDrugProperty/importExcel",
          getDataCount: "/config/medicalDrugProperty/getDataCount",
          saveClean:"/config/medicalDrugProperty/saveCleanMedicalDrugProperty",
          saveAuditAll:"/config/medicalDrugProperty/saveAuditAllMedicalAuditLog",
          saveUndoAllMedicalAuditLog: "/config/medicalDrugProperty/saveUndoAllMedicalAuditLog",
          exportExcelByThread: "/config/medicalDrugProperty/exportExcelByThread",
          exportExcel: "/config/medicalDrugProperty/exportExcel",
        },
        keyFiled:'id',
        tableName: 'MEDICAL_DRUG_PROPERTY',
      }
    },
    computed: {
