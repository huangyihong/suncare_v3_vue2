...
const hasPermissionInstall = {
  install(Vue, options) {
    Vue.directive('has', {
      inserted: function(el, binding, vnode)  {
        //console.log('bind')
        //节点权限处理，如果命中则不进行全局权限处理
        let isHas = !filterNodePermission(el, binding, vnode)
        //console.log('页面权限--', isHas,vnode)
        if (isHas) {
...
export function hasPermission(value) {
  ...
  return !filterGlobalPermission(undefined, {value}, undefined)
}
