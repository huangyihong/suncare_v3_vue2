...
const routerBase = config.routerBase
...
module.exports = {
  ...
  devServer: {
    ...
    proxy: {
      ...
      //准生产
      '/suncare_v4': {
        target: config.localAddress, //请求本地 需要jeecg-boot后台项目https://prepro.lingwww.com/
        ws: true,
        changeOrigin: true,
        pathRewrite: {
          '/suncare_v4': '/suncare_v4'  //默认所有请求都加了jeecg-boot前缀，需要去掉
        }
      },'/prepro_suncare_v3': {
        ...
        changeOrigin: true,
        pathRewrite: {
          '/prepro_suncare_v3': '/suncare_v3'  //默认所有请求都加了jeecg-boot前缀，需要去掉
        }
      },
      '/prod_suncare_v4': {
        ...
        changeOrigin: true,
        pathRewrite: {
          '/prod_suncare_v4': '/suncare_v4'  //默认所有请求都加了jeecg-boot前缀，需要去掉
        }
      },
      '/riskportal_v3': {
        target: config.prodAddress, //请求本地 需要jeecg-boot后台项目
